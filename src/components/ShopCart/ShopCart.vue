<template>
  <div>
    <div class="shopcart">
      <div class="content">
        <div class="content-left" @click="isShowList">
      ...
      <div class="shopcart-list" :style="isShow?'':'display:none'" >
    ...
    <div class="list-mask" :style="isShow?'':'display:none'" @click="isShowList"></div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState(['cartFood', 'shopInfo']),
      ...mapGetters(['totalCount', 'totalPrice']),
      minPrice() {
        const totalPrice = this.totalPrice;
        if(!totalPrice) this.isShow = false;
        const price = this.shopInfo.minPrice;
        if(price > totalPrice){
          this.isEnough = false;
          const p = price - totalPrice;
          return  "还差￥" + p + "元起送";
        } else {
          this.isEnough = true;
          return  "去结算"
