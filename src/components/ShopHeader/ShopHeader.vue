<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="shopInfo.supports" @click="isShowActivity=!isShowActivity">
      <div class="discounts-left">
        <div class="activity" :class="activitTag[shopInfo.supports[0].tyep]">
          <span class="content-tag">
    ...
    <div class="shop-brief-modal" v-if="isShowShopBrief">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="isShowShopBrief=!isShowShopBrief">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="brief-modal-cover" @click="isShowShopBrief=!isShowShopBrief"></div>
    </div>
    <div class="activity-sheet" v-if="isShowActivity">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li class="activity-item"  v-for="(support, index) in shopInfo.supports" :key="index" :class="activitTag[support.type]">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="isShowActivity=!isShowActivity">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
...
<script>
  import {mapState} from 'vuex'
    export default {
      data() {
        return {
          isShowShopBrief: false,
          isShowActivity: false,
          activitTag:['activity-green', 'activity-red', 'activity-orange']
        }
      },
      computed: {
        ...mapState(['shopInfo'])
